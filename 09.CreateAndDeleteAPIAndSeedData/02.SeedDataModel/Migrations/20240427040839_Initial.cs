...
namespace _02.SeedDataModel.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Instructors",
                columns: new[] { "Id", "FirstName", "LastName", "OfficeId" },
                values: new object[,]
                {
                    { 1, "Ahmed", "Abdullah", 1 },
            ...
            // Insert SectionData Here beacuse of Owned Entity can't be added using HasData()
            // Seeding Section to bypass owned entity limitations
