...
namespace _03.SeedDataInitializationLogic
{
    public static class SeedData
    {
        ...
        {
            new Corporate { Id = 2, FirstName = "Noor", LastName = "Saleh", Company = "ABC", JobTitle = "Developer" },
            new Corporate { Id = 4, FirstName = "Huda", LastName = "Ahmed", Company = "ABC", JobTitle = "QA" },
            new Corporate { Id = 7, FirstName = "Yousef", LastName = "Farid", Company = "EFG", JobTitle = "Developer" },
            new Corporate { Id = 8, FirstName = "Layla", LastName = "Mustafa", Company = "EFG", JobTitle = "QA" }
        };
